...
use VirtuaGym\Helpers\MailHelper;
...
class UserPlanController
{
    ...
    public function store()
    {
        try {
             ...
             */
            $email = $this->model->getEmailByUserId($data['id_user']);
            $plan = $this->model->getPlanById($data['id_plan']);
            MailHelper::send($email, 'We got news!', 'You have been assigned to ' . $plan['name']);
